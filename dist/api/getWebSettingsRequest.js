...
function getWebSettingsRequest(accountData, accountConfig) {
    return new Promise(function (resolve, reject) {
        ...
        var uri = "".concat(accountConfig.data.paUrl).concat(GET_WEB_SETTINGS_PATH, "?intAccount=").concat(accountData.data.intAccount, "&sessionId=").concat(accountConfig.data.sessionId);
